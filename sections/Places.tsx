...
const Places: React.FC = () => {
  ...
  const places: Place[] = [
    ...
    { title: t('place_2.title'), city: 'Marrakech', descr: t('place_2.descr'), image: '/places/souk-el-had.jpg' },
    { title: t('place_3.title'), city: 'Agadir', descr: t('place_3.descr'), image: '/places/marina.png' },
    { title: t('place_4.title'), city: 'Agadir', descr: t('place_4.descr'), image: '/places/croco-park.jpg' },
    { title: t('place_5.title'), city: 'Agadir', descr: t('place_5.descr'), image: '/places/paradise-valley.jpg' },
    { title: t('place_6.title'), city: 'Essaouira', descr: t('place_6.descr'), image: '/places/taghazout.webp' },
  ];
        ...
        <Filter places={places} activeTag={activeTag} handleTag={handleTag} tagList={tagList} />
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 w-full max-w-7xl">
            {displayedPlaces.map((place, index) => (
              // <div key={index} className="cursor-pointer" onClick={() => openModal(place)}>
              //   <h3>{place.title}</h3>
              //   <p>{place.descr}</p>
