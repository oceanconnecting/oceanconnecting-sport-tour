...
function Opinion() {
  ...
  const opinions = [
    {
      name: t("opinions.opinion_1.name"),
      descr: t("opinions.opinion_1.opinion"),
      starRate: 5,
      image: "/Opinion/f1.jpg",
    },
    {
      name: t("opinions.opinion_2.name"),
      descr: t("opinions.opinion_2.opinion"),
      starRate: 4,
      image: "/Opinion/f2.jpg",
    },
    {
      name: t("opinions.opinion_3.name"),
      descr: t("opinions.opinion_3.opinion"),
      starRate: 3,
      image: "/Opinion/f3.jpg",
    },
    {
      name: t("opinions.opinion_4.name"),
      descr: t("opinions.opinion_4.opinion"),
      starRate: 5,
      image: "/Opinion/f4.jpg",
    },
    {
      name: t("opinions.opinion_5.name"),
      descr: t("opinions.opinion_5.opinion"),
      starRate: 5,
      image: "/Opinion/f5.jpg",
    },
    {
      name: t("opinions.opinion_6.name"),
      descr: t("opinions.opinion_6.opinion"),
      starRate: 4,
      image: "/Opinion/f6.jpg",
    },
    {
      name: t("opinions.opinion_7.name"),
      descr: t("opinions.opinion_7.opinion"),
      starRate: 5,
      image: "/Opinion/f7.jpg",
    },
  ];
