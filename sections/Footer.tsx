            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                ...
                <form className="w-full">
                    ...
                    <input
                        ...
                        className="w-full pl-5 border-none focus:border-transparent focus:ring-transparent sm:text-sm outline-none"
                    />

                    <button className='text-white py-3 px-5 w-fit text-nowrap rounded-full border border-background-50 bg-background-50 hover:bg-opacity-80 active:bg-opacity-35 active:text-text-950 transition duration-300'>Contact</button>
                    </div>
                </form>
                </div>
