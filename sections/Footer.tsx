...
return (
    ...
    <div className="col-span-2 m-5 flex items-center justify-start gap-6 lg:col-span-5 ">
        <p  className='ml-5'>
            <svg className="h-7 " viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <ul className="col-span-2 ml-10 flex lg:hidden gap-6 lg:col-span-5 lg:justify-start">
        <li>
            <a
    ...
    <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900">
        {
            navbarLink.map((link, idx) => (
                <li key={idx} className='flex justify-center'>
                    <a href={link.link} className="mr-4 hover:underline md:mr-6">{link.title}</a>
                </li>
            ))
        }
    </ul>
