...
function Footer() {
  ...
  const tn = useTranslations("homepage.navbar");
    ...
    <footer className="p-4 bg-background-100 md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        <div className="col-span-2 m-5 flex items-center justify-start gap-6 lg:col-span-5 ">
          ...
          <Link
            href="#hero"
            className="justify-center flex-1 items-center text-xl font-semibold text-gray-900"
          >
            <span className="mt-4 text-text-900">
              <h1 className="text-xl lg:text-2xl text-start">
                {th("highlighted")}
              </h1>
            </span>
          </Link>
        ...
        <ul className="col-span-2 mx-10 flex lg:hidden gap-6 lg:col-span-5 lg:justify-start">
          <li>
            <a
              href="https:www.facebook.com/the.ocean.connecting/"
              rel="noreferrer"
        ...
        <p className="my-6 text-black-500  text-gray-400">
          {tf("tanks")}
          <a
            className=" text-primary-600 mx-2"
        ...
        <ul className="flex flex-wrap justify-center items-center mb-6 text-text-900">
          {navbarLink.map((link, idx) => (
            <li key={idx} className="flex justify-center">
              <a href={link.link} className="mr-4 hover:underline md:mr-6">
                {link.title}
              </a>
            </li>
          ))}
