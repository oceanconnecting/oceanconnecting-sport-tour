        ...
        <div className="grid lg:grid-cols-2 gap-4 h-full justify-center items-center">
          <div>
            <div className="flex items-center flex-col">
              ...
              <p className="mt-4 text-center lg:text-left text-text-50 sm:text-xl/relaxed max-w-lg">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam ut delectus commodi quaerat dicta? Soluta
                voluptatum, eligendi quas iusto in, vero qui repellat provident voluptatem doloribus sed delectus ipsa error.
              </p>
            </div>
          </div>
