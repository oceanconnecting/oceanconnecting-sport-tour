...
function choose() {
  ...
  const ChooseData = [
    {
      icon: <PiShieldCheckDuotone className="text-4xl text-primary-200"/>,
      title: t("choose_1.title"),
      subtitle: t("choose_1.descr"),
      bg: "bg-primary-950",
    },
    {
      icon: <PiGlobeHemisphereWestDuotone className="text-4xl text-primary-200"/>,
      title: t("choose_2.title"),
      subtitle: t("choose_2.descr"),
      bg: "bg-primary-950",
    },
    {
      icon: <PiBookBookmarkDuotone className="text-4xl text-primary-200"/>,
        ...
        {ChooseData.map((item: any, index: any) => (
            <div key={index} className="w-full transition-all duration-200 group hover:bg-secondary-950 max-w-xs border-black rounded-xl border-opacity-35">
              <div className="flex flex-col items-center text-center p-6">
                <div className="p-3 rounded-full mb-4 bg-primary-950 group-hover:scale-105 group-hover:bg-primary-800 transition duration-200">
                  {item.icon}
                </div>
