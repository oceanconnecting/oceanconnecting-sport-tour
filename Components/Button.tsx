...
const classes = cva("", {
  variants: {
    variant: {
      primary: "text-text-50 py-3 flex justify-center px-8 rounded-2xl shadow-md active:shadow-none focus:ring-2 ring-primary-400/50 text-white bg-primary-600 active:bg-primary-400 hover:bg-primary-500 transition duration-300",
