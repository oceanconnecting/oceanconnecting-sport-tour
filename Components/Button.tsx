...
const classes = cva("", {
  variants: {
    variant: {
      primary: "text-text-50 py-3 px-5 rounded-full border-t shadow-md active:shadow-sm border-primary-600 focus:outline outline-primary-400/50 text-white bg-primary-500 hover:bg-opacity-80 active:bg-primary-300 hover:bg-primary-400 transition duration-300",
