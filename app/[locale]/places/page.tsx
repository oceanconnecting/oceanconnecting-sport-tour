...
function page() {
  const places = [
    ...
    { "title": "Corniche", "descr": "Beachfront promenade with cafes and scenic views.", "image": "/places/corniche.jpg" },
    ...
    { "title": "Marina", "descr": "Modern marina with shops, restaurants, and yachts.", "image": "/places/marina.jpg" },
    ...
    { "title": "Ocean Site Services", "descr": "Coastal area with water sports and activities.", "image": "/places/ocean-site-services.jpg" },
    ...
    { "title": "Taghazout", "descr": "Popular surf town with stunning beaches.", "image": "/places/taghazout.jpg" }
  ];
  return (
